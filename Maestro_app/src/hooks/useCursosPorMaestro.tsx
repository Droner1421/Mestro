...
interface UseCursosPorMaestro {
    isLoading: boolean;
    LoadCursos: () => void;
    cursos: CursoData[];
}

export const useCursosPorMaestro = (idMaestro: number): UseCursosPorMaestro => {
    ...
    const LoadCursos = async () => {
        ...
        const url = `/maestros/cursos/maestro/${idMaestro}?page=${pageRef.current}&limit=10`;
