...
interface UseExamenesPorFecha {
    isLoading: boolean;
    LoadExamenes: () => void;
    examenes: ExamenData[];
}

export const useExamenesPorFecha = (fecha: string): UseExamenesPorFecha => {
    ...
    const LoadExamenes = async () => {
        ...
        const url = `/maestros/examenes/fecha/${fecha}?page=${pageRef.current}&limit=10`;
